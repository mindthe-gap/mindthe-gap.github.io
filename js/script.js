...
jQuery(function ($) {
    ...
    $(".progress-bar").each(function () {
        $(this).appear(function () {
            $(this).animate({width: $(this).attr("aria-valuenow") + "%"}, 1500)
        });
    });
...
function myFunction() {
  document.getElementById("errortext1").innerHTML = "<br> Sorry, application has closed as we've reached maximum capacity. Subscribe to be kept informed of other opportunities as they come!";
...
function myFunction1() {
    document.getElementById("errortext2").innerHTML = "<br> Sorry, application has closed as we've reached maximum capacity. Subscribe to be kept informed of other opportunities as they come!";
